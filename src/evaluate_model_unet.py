...
def visualize_results(model, dataset, save_dir):
    ...
    plt.tight_layout()
    save_path = os.path.join(save_dir, f'evaluation_visualization_unet.png')
...
def evaluate_model():
    ...
    if args.results_dir:
        ...
        if backbone == 'resnet':
            RESULTS_DIR = 'results/evaluation/unet/ResNet'
        else:
            RESULTS_DIR = 'results/evaluation/unet/EfficientNet'
    ...
    visualize_results(model, test_dataset, RESULTS_DIR)
