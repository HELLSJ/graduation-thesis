...
def test_generalization():
    """Test UNet++ model generalization on different datasets"""
    global model
    ...
    if args.results_dir:
        ...
        if backbone == 'resnet':
            RESULTS_DIR = 'results/generalization_test/unetpp/ResNet'
        else:
            RESULTS_DIR = 'results/generalization_test/unetpp/EfficientNet'
